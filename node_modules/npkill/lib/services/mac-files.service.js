...
exports.MacFilesService = void 0;
const child_process_1 = require("child_process");
const operators_1 = require("rxjs/operators");
const unix_files_service_1 = require("./unix-files.service");
class MacFilesService extends unix_files_service_1.UnixFilesService {
    getFolderSize(path) {
        const du = child_process_1.spawn('du', ['-sk', path]);
...
exports.MacFilesService = MacFilesService;
